...
console.log("Todo el texro en minusculas:" + text.toLowerCase());
console.log("Todo el texro en minusculas:" + text.toUpperCase());
console.log("Posición de la G: " + text.indexOf("G"));
